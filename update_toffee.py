...
# ১. টুফি চ্যানেল লিস্ট (৭৫টি চ্যানেল)
BASE_CHANNELS = [
...
# ২. ডাইরেক্ট কুকি ফেচ করা
def fetch_toffee_cookie():
    print("Fetching Toffee Edge-Cache-Cookie...")
    headers = {
            ...
            if "Edge-Cache-Cookie" in cookie_header:
                for part in cookie_header.split(";"):
                    if "Edge-Cache-Cookie=" in part:
                        print("✅ Active Cookie Acquired!")
                        return part.strip()
        except:
            pass
            
    # ব্যাকআপ একটিভ কুকি (কখনো ক্যানসেল হবে না)
...
def generate_playlist():
    print("🚀 Generating Toffee Playlist...")
    cookie = fetch_toffee_cookie()
    ua = "okhttp/4.11.0"
    ...
    print("✅ Successfully saved 75 Toffee channels!")
